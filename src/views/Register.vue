    ...
    <div class="row contentLog">
      <div class="col-md-6 col-12 colFormLog">
        <div class="LogInfo">
          ...
          <div>
            <h6 class="hLog">أنشئ حسابك الخاص مجاناَ</h6>
          </div>
                ...
                >
                  <g id="google" transform="translate(-23 -21)">
                    <path
                      ...
                      transform="translate(-233.263 -184.639)"
                      fill="#167ee6"
                    />
                    <path
                      id="Path_2018"
                      ...
                      transform="translate(-30.055 -291.459)"
                      fill="#12b347"
                    />
                    <path
                      id="Path_2019"
                      ...
                      transform="translate(-223.5 -341.137)"
                      fill="#0f993e"
                    />
                    <path
                      id="Path_2020"
          ...
          <div class="divPOrSignup">
            ...
            <p class="pOrSignUp">أو تسجيل الدخول عبر</p>
            <p class="PLine">__________</p>
          </div>
          <div class="divEmail">
            <input
              ...
              type="email"
              class="EmailFirstSignUp"
              v-model="$store.state.register_data.email"
            />
          </div>
          <div>
            <!-- <router-link to=""> -->
            <button class="btnLog" @click="goToRegister()">
              تسجيل الاشتراك عبر البريد
            </button>
            <!-- </router-link> -->
          </div>
          <div>
...
export default {
  methods: {
    goToRegister() {
      if (this.$store.state.register_data.email != null) {
        setTimeout(() => {
          this.$router.push("/registerByEmail");
        }, 500);
      } else {
        this.$notify({
          group: "foo",
          type: "error",
          text: "يرجي إدخال البريد الإلكتروني ",
        });
      }
    },
  },
