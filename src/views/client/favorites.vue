    ...
    <div class="row">
      <div class="col-lg-3 col-md-4 col-12 search-lawyers-filter">
        ...
        <div class="divDeadline">
          ...
          <label class="containerlbl">
            <a href="favoriteOffice.html" style="color: #a2a2a6"> مكتب </a>
            <input type="checkbox" />
            <span class="checkmark"></span>
          </label>
          <label class="containerlbl">
            <a href="favoriteOffice.html" style="color: #a2a2a6"> محامي </a>
            <input type="checkbox" />
            <span class="checkmark"></span>
          </label>
          <label class="containerlbl">
            <a href="favorite.html" style="color: #a2a2a6"> طلب </a>
      ...
      <div class="col-lg-9 col-md-8 col-12 search-lawyers-content">
        <div class="divSearch">
          <input type="text" class="lawyers-search-box" placeholder="   بحث" />
            ...
            <div class="col-lg-9 col-md-8 col-12">
              ...
              >
                <div class="imgProfile imgProfileClient imgNofi">
                  <img src="@/assets/img/lawyer.png" alt="" />
                ...
                <div class="divNameClient">
                  <div class="flexHeadNameOffice">
                    <a href="profile_Office.html">
                      <p class="pNameflexHeadNameOffice">مكتب فرسان العدالة</p>
                    </a>
                    <p class="pNumflexHeadNameOffice">88%</p>
                ...
                <div class="dropdown">
                  ...
                  >
                    ...
                    <a
                      ...
                      style="color: #000 !important; padding-right: 10px"
                    >
                      <label class="lblListMsg">أضف للمفضلة </label>
                    </a>
                    <a
                      class="dropdown-item"
                      href="#"
