    ...
    <div class="row">
      <div class="col-lg-9 col-md-8 col-12">
        <div class="titleAndIcons">
          <h3 class="hTitle">إضافة عمل جديد</h3>
        </div>
...
export default {
  ...
  methods: {
    ...
    selectImg(event) {
      ...
      console.log("imgg: "+ this.img);
      console.log("imggfile: "+ event.target.files[0]);
    },
    selectFile(event ) {
      this.file = event.target.files[0];
       console.log("filee: "+ this.img);
    },
    savePortfolio() {
      ...
      this.$http.post("lawyer/auth/lawyer/galleries", form).then(res => {
